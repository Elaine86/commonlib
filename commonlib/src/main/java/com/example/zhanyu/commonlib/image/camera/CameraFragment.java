...
public class CameraFragment extends BaseFragment implements SurfaceHolder.Callback, Camera.PictureCallback {
    ...
    private void setupCamera() {
        ...
        final View changeCameraFlashModeBtn = Objects.requireNonNull(getView()).findViewById(R.id.flash);
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            ((CameraActivity) Objects.requireNonNull(getActivity())).backTo(msg.obj.toString());
        }
    };
