package com.example.zhanyu.commonlib.image.photopicker;
    ...
    public void onBindViewHolder(final PhotoPickerViewHolder holder, final int position) {
        ...
        holder.photopicker_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                holder.photopicker_choice.setImageResource(!flag ? ResourceUtils.getMipmapIdByName("ic_choice_select") : ResourceUtils.getMipmapIdByName("ic_choice_normal"));
                if (!flag) {
        ...
        holder.photopicker_choice.setImageResource(models.get(position).isSelect() ? ResourceUtils.getMipmapIdByName("ic_choice_select") : ResourceUtils.getMipmapIdByName("ic_choice_normal"));
    }
